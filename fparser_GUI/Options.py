...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_newFolder = QtWidgets.QLabel(self.centralwidget)
        self.label_newFolder.setObjectName("label_newFolder")
        self.verticalLayout_6.addWidget(self.label_newFolder)
        self.lineEdit_newFolder = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_newFolder.setObjectName("lineEdit_newFolder")
        self.verticalLayout_6.addWidget(self.lineEdit_newFolder)
        self.verticalLayout_7.addLayout(self.verticalLayout_6)
        spacerItem3 = QtWidgets.QSpacerItem(40, 200, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        ...
        self.verticalLayout_7.addWidget(self.buttonBox_accept)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_newFolder.setText(_translate("MainWindow", "Name of the new folder that contains the fortran modules and interfaces."))
        self.lineEdit_newFolder.setText(_translate("MainWindow", "__Interface__"))
