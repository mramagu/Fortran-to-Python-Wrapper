...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_9 = QtWidgets.QFrame(self.tab_makefile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_f2py.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">NOTE:</span></p><p>You can execute &quot;f2py -c --help-fcompiler&quot; in your command window</p><p>to see which fortran compilers are available in your computer.</p></body></html>"))
