...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_make_env.setGeometry(QtCore.QRect(40, 120, 361, 16))
        self.label_make_env.setObjectName("label_make_env")
        self.label_make_FC = QtWidgets.QLabel(self.tab_makefile)
        self.label_make_FC.setGeometry(QtCore.QRect(40, 190, 271, 16))
        self.label_make_FC.setObjectName("label_make_FC")
        self.comboBox = QtWidgets.QComboBox(self.tab_makefile)
        self.comboBox.setGeometry(QtCore.QRect(430, 190, 161, 22))
        self.comboBox.setObjectName("comboBox")
        self.lineEdit = QtWidgets.QLineEdit(self.tab_makefile)
        self.lineEdit.setGeometry(QtCore.QRect(450, 110, 113, 22))
        self.lineEdit.setText("")
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.tab_makefile)
        ...
        self.label_make_OS = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.label_make_OS.setObjectName("label_make_OS")
        self.horizontalLayout_4.addWidget(self.label_make_OS)
        self.comboBox_make = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        ...
        self.pushButton_make1 = QtWidgets.QPushButton(self.horizontalLayoutWidget)
