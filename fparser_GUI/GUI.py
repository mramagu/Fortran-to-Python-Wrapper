...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_makeYes = QtWidgets.QRadioButton(self.tab_makefile)
        self.radioButton_makeYes.setChecked(True)
        self.radioButton_makeYes.setObjectName("radioButton_makeYes")
        self.verticalLayout_17.addWidget(self.radioButton_makeYes)
        self.radioButton_makeNo = QtWidgets.QRadioButton(self.tab_makefile)
        self.radioButton_makeNo.setObjectName("radioButton_makeNo")
        self.verticalLayout_17.addWidget(self.radioButton_makeNo)
        ...
        self.verticalLayout_14.addWidget(self.label_make_env)
        ...
        self.lineEdit_makeEnv = QtWidgets.QLineEdit(self.tab_makefile)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_makeEnv.sizePolicy().hasHeightForWidth())
        self.lineEdit_makeEnv.setSizePolicy(sizePolicy)
        self.lineEdit_makeEnv.setText("")
        self.lineEdit_makeEnv.setObjectName("lineEdit_makeEnv")
        self.verticalLayout_13.addWidget(self.lineEdit_makeEnv)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Do you want to use a conda environment?"))
        self.radioButton_makeYes.setText(_translate("MainWindow", "Yes."))
        self.radioButton_makeNo.setText(_translate("MainWindow", "No."))
        self.label_make_env.setText(_translate("MainWindow", "Write the python environment in which you want to work."))
        ...
        self.comboBox_makeFC.setItemText(1, _translate("MainWindow", "gfortran"))
