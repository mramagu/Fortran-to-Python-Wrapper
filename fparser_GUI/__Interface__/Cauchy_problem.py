...
class Lagrange_interpolation:
    def Lagrange_polynomials(x,xp):
        """
            ...
            xp (real): None
        """
        return Cauchy_problemf.Lagrange_interpolation_py.Lagrange_polynomials_py(x,xp)
    def Stencilv(Order,N):
        """
            ...
            N (integer): None
        """
        return Cauchy_problemf.Lagrange_interpolation_py.Stencilv_py(Order,N)
    def Lagrange_error_polynomial(x,xp):
        """
            ...
            xp (real): None
        """
        return Cauchy_problemf.Lagrange_interpolation_py.Lagrange_error_polynomial_py(x,xp)
    def Lebesgue_functions(x,xp):
        """
            ...
            xp (real): None
        """
        return Cauchy_problemf.Lagrange_interpolation_py.Lebesgue_functions_py(x,xp)
    def PI_error_polynomial(x,xp):
        """
            ...
            xp (real): None
        """
        return Cauchy_problemf.Lagrange_interpolation_py.PI_error_polynomial_py(x,xp)
class Linear_systems:
    def Solve_LU(A,b):
        """
            ...
            b (real): None
        """
        return Cauchy_problemf.Linear_systems_py.Solve_LU_py(A,b)
    def Gauss(A,b):
        """
            !***************************************************************************
            ...
            b (real): None
        """
        return Cauchy_problemf.Linear_systems_py.Gauss_py(A,b)
    def Condition_number(A):
        """
            ...
            A (real): None
        """
        return Cauchy_problemf.Linear_systems_py.Condition_number_py(A)
    def Solve_LU_band(A,b,rj):
        """
            ...
            rj (integer): None
        """
        return Cauchy_problemf.Linear_systems_py.Solve_LU_band_py(A,b,rj)
    def Tensor_product(u,v):
        """
            ...
            v (real): None
        """
        return Cauchy_problemf.Linear_systems_py.Tensor_product_py(u,v)
    def LU_factorization(A):
        """
            ...
            A (real): None
        """
        Cauchy_problemf.Linear_systems_py.LU_factorization_py(A)
    def Swap(A,B):
        """
            !***************************************************************************
            !* Swap two vectors 
            ...
            B (real): None
        """
        Cauchy_problemf.Linear_systems_py.Swap_py(A,B)
    def Power_method(A,l,U):
        """
            !****************************************************************
            ...
            U (real): None
        """
        Cauchy_problemf.Linear_systems_py.Power_method_py(A,l,U)
    def Inverse_power_method(A,l,U):
        """
            !****************************************************************
            ...
            U (real): None
        """
        Cauchy_problemf.Linear_systems_py.Inverse_power_method_py(A,l,U)
    def Eigenvalues_PM(A,l,U):
        """
            !****************************************************************
            ...
            U (real): None
        """
        Cauchy_problemf.Linear_systems_py.Eigenvalues_PM_py(A,l,U)
    def SVD(A,sigma,U,V):
        """
            !****************************************************************
            ...
            V (real): None
        """
        Cauchy_problemf.Linear_systems_py.SVD_py(A,sigma,U,V)
    def LU_band_factorization(A,rj):
        """
            ...
            rj (integer): None
        """
        Cauchy_problemf.Linear_systems_py.LU_band_factorization_py(A,rj)
# class ODE_Interface:
class Jacobian_module:
    def Jacobian(FunctionRN_RN,xp):
        ...
        return Cauchy_problemf.Jacobian_module_py.Jacobian_py(FunctionRN_RN_py,xp)
    def Jacobianc(FunctionRN_RNE,xp):
        ...
        return Cauchy_problemf.Jacobian_module_py.Jacobianc_py(FunctionRN_RNE_py,xp)
# class Temporal_scheme_interface:
class Embedded_RKs:
    def get_eRK_effort():
        """
        """
        return Cauchy_problemf.Embedded_RKs_py.get_eRK_effort_py()
    def Step_size(dU,tolerance,q,h):
        """
            ...
            h (real): None
        """
        return Cauchy_problemf.Embedded_RKs_py.Step_size_py(dU,tolerance,q,h)
    def set_eRK_name(name):
        """
            name (character(len=*)): None
        """
        Cauchy_problemf.Embedded_RKs_py.set_eRK_name_py(name)
    def set_eRK_tolerance(eps):
        """
            eps (real): None
        """
        Cauchy_problemf.Embedded_RKs_py.set_eRK_tolerance_py(eps)
    def ERK_scheme(F,t1,t2,U1,U2,ierr):
        """
            ...
            ierr (integer): None
        """
        Cauchy_problemf.Embedded_RKs_py.ERK_scheme_py(F,t1,t2,U1,U2,ierr)
    def RK_scheme(name,tag,F,t1,t2,U1,U2):
        """
            ...
            U2 (real): None
        """
        Cauchy_problemf.Embedded_RKs_py.RK_scheme_py(name,tag,F,t1,t2,U1,U2)
    def Butcher_array(name,Ne):
        """
            ...
            Ne (integer): None
        """
        Cauchy_problemf.Embedded_RKs_py.Butcher_array_py(name,Ne)
class Wrappers:
    def get_weRK_effort():
        """
        """
        return Cauchy_problemf.Wrappers_py.get_weRK_effort_py()
    def get_wGBS_effort():
        """
        """
        return Cauchy_problemf.Wrappers_py.get_wGBS_effort_py()
    def get_wABM_effort():
        """
        """
        return Cauchy_problemf.Wrappers_py.get_wABM_effort_py()
    def set_weRK_name(name):
        """
            ...
            name (character(len=*)): None
        """
        Cauchy_problemf.Wrappers_py.set_weRK_name_py(name)
    def set_weRK_tolerance(eps):
        """
            eps (real): None
        """
        Cauchy_problemf.Wrappers_py.set_weRK_tolerance_py(eps)
    def set_wGBS_tolerance(eps):
        """
            ...
            eps (real): None
        """
        Cauchy_problemf.Wrappers_py.set_wGBS_tolerance_py(eps)
    def set_wABM_tolerance(eps):
        """
            ...
            eps (real): None
        """
        Cauchy_problemf.Wrappers_py.set_wABM_tolerance_py(eps)
    def WERK(ODES,t1,t2,U1,U2,ierr):
        ...
        Cauchy_problemf.Wrappers_py.WERK_py(ODES_py,t1,t2,U1,U2,ierr)
    def WODEX(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Wrappers_py.WODEX_py(ODES_py,t1,t2,U1,U2,ierr)
    def WODE113(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Wrappers_py.WODE113_py(ODES_py,t1,t2,U1,U2,ierr)
class Gragg_Burlisch_Stoer:
    def get_GBS_effort():
        """
        """
        return Cauchy_problemf.Gragg_Burlisch_Stoer_py.get_GBS_effort_py()
    def set_GBS_tolerance(eps):
        """
            eps (real): None
        """
        Cauchy_problemf.Gragg_Burlisch_Stoer_py.set_GBS_tolerance_py(eps)
    def Modified_midpoint_scheme(F,t0,t,U0,Un,n):
        """
            ...
            n (integer): None
        """
        Cauchy_problemf.Gragg_Burlisch_Stoer_py.Modified_midpoint_scheme_py(F,t0,t,U0,Un,n)
    def GBS_Richardson_coefficients(n,b):
        """
            ...
            b (real): None
        """
        Cauchy_problemf.Gragg_Burlisch_Stoer_py.GBS_Richardson_coefficients_py(n,b)
    def GBS_Scheme(F,t1,t2,U1,U2,ierr):
        """
            ...
            ierr (integer): None
        """
        Cauchy_problemf.Gragg_Burlisch_Stoer_py.GBS_Scheme_py(F,t1,t2,U1,U2,ierr)
    ...
    def Newton(FunctionRN_RN,x0):
        ...
        def FunctionRN_RN_py(i,x):
            ...
            if i == 1:
                global_FunctionRN_RN_var = FunctionRN_RN(x)
            return global_FunctionRN_RN_var[i]
        Cauchy_problemf.Non_Linear_Systems_py.Newton_py(FunctionRN_RN_py,x0)
    def Newtonc(FunctionRN_RNE,x0):
        ...
        def FunctionRN_RNE_py(i,x):
            ...
            if i == 1:
                global_FunctionRN_RNE_var = FunctionRN_RNE(x)
            return global_FunctionRN_RNE_var[i]
        Cauchy_problemf.Non_Linear_Systems_py.Newtonc_py(FunctionRN_RNE_py,x0)
class Adams_Bashforth_Moulton:
    def get_ABM_effort():
        """
        """
        return Cauchy_problemf.Adams_Bashforth_Moulton_py.get_ABM_effort_py()
    def Factorial(n):
        """
            n (integer): None
        """
        return Cauchy_problemf.Adams_Bashforth_Moulton_py.Factorial_py(n)
    def set_ABM_tolerance(eps):
        """
            ...
            eps (real): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.set_ABM_tolerance_py(eps)
    def PC_ABM(F,t1,t2,U1,U2,ierr):
        """
            ...
            ierr (integer): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.PC_ABM_py(F,t1,t2,U1,U2,ierr)
    def Predictor_AB(F,t1,t2,U1,U2,ierr):
        """
            ...
            ierr (integer): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.Predictor_AB_py(F,t1,t2,U1,U2,ierr)
    def Corrector_AM(F,t1,t2,U1,Up,U2,ierr):
        """
            ...
            ierr (integer): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.Corrector_AM_py(F,t1,t2,U1,Up,U2,ierr)
    def set_ABM_IC(F,U0,t0,h):
        """
            ...
            h (real): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.set_ABM_IC_py(F,U0,t0,h)
    def Initial_conditions(F,U0,t0,h):
        """
            ...
            h (real): None
        """
        Cauchy_problemf.Adams_Bashforth_Moulton_py.Initial_conditions_py(F,U0,t0,h)
class Temporal_Schemes:
    def get_effort():
        """
        """
        return Cauchy_problemf.Temporal_Schemes_py.get_effort_py()
    def Euler(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Euler_py(ODES_py,t1,t2,U1,U2,ierr)
    def Inverse_Euler(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Inverse_Euler_py(ODES_py,t1,t2,U1,U2,ierr)
    def Crank_Nicolson(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Crank_Nicolson_py(ODES_py,t1,t2,U1,U2,ierr)
    def Runge_Kutta2(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Runge_Kutta2_py(ODES_py,t1,t2,U1,U2,ierr)
    def Runge_Kutta4(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Runge_Kutta4_py(ODES_py,t1,t2,U1,U2,ierr)
    def Leap_Frog(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Leap_Frog_py(ODES_py,t1,t2,U1,U2,ierr)
    def Adams_Bashforth2(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Adams_Bashforth2_py(ODES_py,t1,t2,U1,U2,ierr)
    def Adams_Bashforth3(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Adams_Bashforth3_py(ODES_py,t1,t2,U1,U2,ierr)
    def Predictor_Corrector1(ODES,t1,t2,U1,U2,ierr):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Temporal_Schemes_py.Predictor_Corrector1_py(ODES_py,t1,t2,U1,U2,ierr)
    def set_tolerance(tolerance):
        """
            tolerance (real): None
        """
        Cauchy_problemf.Temporal_Schemes_py.set_tolerance_py(tolerance)
    def set_solver(family_name,scheme_name):
        """
            family_name (character(len=*)): None
            scheme_name (character(len=*)): None
        """
        Cauchy_problemf.Temporal_Schemes_py.set_solver_py(family_name,scheme_name)
    ...
    def Cauchy_ProblemS(Time_Domain,ODES,Solution,Scheme):
        ...
        def ODES_py(i,U,t):
            ...
            if i == 1:
                global_ODES_var = ODES(U,t)
            return global_ODES_var[i]
        Cauchy_problemf.Cauchy_Problem_py.Cauchy_ProblemS_py(Time_Domain,ODES_py,Solution,Scheme)